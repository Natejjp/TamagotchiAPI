...
namespace TamagotchiAPI.Controllers
{
    ...
    public class PetsController : ControllerBase
    {
        ...
        //
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Pet>>> GetPets(string search)
        {
            ...
            {
                return await _context.Pets.Where(pet => pet.Name.ToLower().Contains(search.ToLower())).ToListAsync();
            }
        }
        ...
        public async Task<ActionResult<Playtime>> CreateFeedingForPet(int id)
        {
        ...
        public async Task<ActionResult<Playtime>> CreateScoldingForPet(int id)
        {
